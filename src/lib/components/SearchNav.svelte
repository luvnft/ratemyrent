...
>
	<select
		class={`${classes.select} rounded border border-white bg-transparent px-3 text-white transition-colors focus:border-white focus:outline-none group-hover:bg-white group-hover:text-black [&:has(+_div_>_input:focus)]:bg-white [&:has(+_div_>_input:focus)]:text-black`}
	...
	<div class="w-full sm:w-auto group-hover:[&>input]:bg-white group-hover:[&>input]:text-black">
		...
		<input
			class={`${classes.input} peer rounded border border-white bg-transparent px-3 text-white transition-colors focus:border-white focus:bg-white focus:text-black focus:outline-none`}
			type="search"
			name="search"
			enterkeyhint="search"
